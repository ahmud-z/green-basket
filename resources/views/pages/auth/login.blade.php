      ...
      <div class="max-w-md mx-auto bg-white rounded-lg shadow-md overflow-hidden">
        <div class="p-6">
          ...
          <form action="{{ route('login') }}" method="post">
            ...
            <div class="mb-6">
              <button type="submit" class="w-full bg-emerald-600 text-white py-2 px-4 rounded-md font-medium hover:bg-emerald-700 transition">Login</button>
            </div>

            <div class="flex items-center justify-center">
              <span class="text-gray-600">Don't have an account?</span>
              <a href="{{ route('register') }}" class="ml-2 text-emerald-600 hover:underline">Register</a>
            </div>
          </form>
        </div>
      </div>
